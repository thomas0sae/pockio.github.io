---
layout: page
title: Pockio Terms and Conditions
permalink: /pockio/terms-conditions/
comments: false
---

Your use of the Pockio website and mobile applications (iOS/Android) provided by Emwave Technologies Private Limited (referred to as "Emwave" or "we" or "us" or "our") is subject to these terms of use. It is important that you read them carefully. If you do not agree with any part of these terms or our privacy policy, please refrain from using the website or app, or any other service we provide. In these Terms and Conditions, the following words and phrases shall have the following meanings:
"App" refers to the mobile application named Pockio - Kids Money Jars available for download on iOS/Android.
"Service" refers to all features, functions, and services offered by the App.
"User" refers to any person who downloads, installs, or uses the App, including parents, guardians, and children.
...
Important reminder: We reserve the right to modify the terms of use and privacy policy at any time, at our discretion. We may do so for various reasons, such as to reflect changes in our business practices, new features, or legal requirements. The latest version of these documents, including the date of the last update, can be found on our website and app. We advise you to periodically review the terms and privacy policy for changes, as any modifications will be effective immediately upon publication. By continuing to use the Pockio app and website after such revisions, you indicate your acceptance of the updated terms of use. We will notify users of Pockio via our app when we make changes to these documents.

Pockio is a financial education platform designed to help children learn money management skills through virtual money jars, saving goals, and allowance tracking. By creating an account on Pockio, you warrant and represent the following:

If you are a parent or guardian, you are at least 18 years old.
You are legally allowed to use the App and provide consent for your child's use.
You are capable of entering into a legally binding contract with Pockio.
You are not prohibited from using our service under any applicable law.
You will not attempt to access Pockio after being banned or removed from the platform.
...
Pockio is designed for use by children under the supervision of their parents or guardians. We comply with applicable children's privacy laws, including the Children's Online Privacy Protection Act (COPPA). Parents or guardians must create and manage accounts on behalf of their children. By creating an account for your child, you consent to the collection and use of your child's information as described in our Privacy Policy. Parents and guardians have the right to review, modify, or delete their child's personal information at any time by contacting us.

### Creation of New Account with Pockio

To access the Website or App, a parent or guardian must first register and create a family account known as "Your Account." During the account creation process, we will require basic information such as parent/guardian name, email address, and information about your children (such as name and age) to set up their money jars. Your email address will serve as your contact identifier when contacting our support team.
...
By using Pockio, you consent to receive notifications and communication regarding the service through email and other available means. As a user of Pockio, you are expected to use the App responsibly and ensure appropriate supervision of children using the App.

Pockio has the authority to investigate and terminate your account without refund or reimbursement if we suspect that you have misled Pockio or its users, misused the service, or engaged in inappropriate or unlawful behavior.

Pockio offers assistance and guidance through its customer care team, and when you contact us, you agree to refrain from engaging in abusive, obscene, profane, offensive, threatening, harassing, or any other inappropriate behavior. If we find that your behavior towards our customer care team or any other employee is threatening or offensive, we reserve the right to terminate your account without prior warning.
...
Pockio is designed for educational purposes to teach children about money management concepts. The App uses virtual money jars and does not handle real financial transactions or actual currency. Any features simulating financial activities are for educational purposes only. Pockio is not a bank or financial institution and does not provide banking services.

### Payment

The App may offer premium features, subscriptions, or products for sale. If you choose to purchase a product or service, you will be required to provide payment information, such as your credit card or other payment method. By providing such information, you represent and warrant that you are authorized to use the payment method and authorize the App or its third-party payment processor to charge the payment method for the total amount of the purchase, including any applicable taxes and fees.
